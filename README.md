...
| 🌐 **Ba ngôn ngữ** | Chuyển giữa **Tiếng Việt · English · 日本語** trong Cài đặt. Đổi cả tên thứ/tháng và cách rút gọn số theo đúng thói quen bản xứ: `¥66,7N` (Việt) · `¥66.7K` (Anh) · `¥6.7万` (Nhật) |
| 🌗 **Giao diện** | Sáng / tối / theo hệ thống. Thanh công cụ 5 tab cố định dưới màn hình |
| 📄 **Chính sách bảo mật** | `privacy.html` ba thứ tiếng, dùng luôn được làm URL nộp cửa hàng ứng dụng |
...
├─ privacy.html            Chính sách bảo mật 3 thứ tiếng (trang độc lập)
...
│  ├─ i18n.js              Từ điển Việt→Anh→Nhật + dịch cây DOM khi đổi ngôn ngữ
...
| Chuyển sang 日本語: quét 5 màn hình + bảng nhập giao dịch + bảng nhập công việc, **sạch hoàn toàn** | ✅ |
| Quy ước bản xứ đúng cho cả 3: `Tháng 8/2026` · `Aug 2026` · `2026年8月` — và `¥66,7N` · `¥66.7K` · `¥6.7万` | ✅ |
...
*Phiên bản 1.2.0 · Việt / English / 日本語 · Mặc định đơn vị JPY (đổi được trong Cài đặt)*
